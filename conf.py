...
BLOG_AUTHOR = "Flancian"
BLOG_TITLE = "Flancia"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://flancia.org/"
...
POSTS = (
    ("posts/*.rst", "mine", "post.tmpl"),
    ("posts/*.md", "mine", "post.tmpl"),
    ("posts/*.txt", "mine", "post.tmpl"),
    ("posts/*.html", "mine", "post.tmpl"),
)
PAGES = (
    ("pages/*.rst", "", "page.tmpl"),
    ("pages/*.md", "", "page.tmpl"),
...
TAG_DESCRIPTIONS = {
   DEFAULT_LANG: {
       "meta": "Meta-blog posts about blogging about blogging.",
       "ml": "Posts about machine learning.",
       "compsci": "Posts about computer science in general.",
       "music": "Posts about music that I like, or about playing the piano (or trying to).",
       "diary": "Posts which follow the diary format to some extent; they are about my daily life, or about random thoughts that came up while living it."
   },
}
...
FAVICONS = (
    ("icon", "/favicon.ico?v2", "16x16"),
    ("icon", "/favicon.png?v2", "128x128"),
)
...
MARKDOWN_EXTENSIONS = ['markdown.extensions.fenced_code', 'markdown.extensions.codehilite', 'markdown.extensions.extra', 'markdown.extensions.meta', 'footnotes']
...
ADDITIONAL_METADATA = {'status': 'draft'}
...
TWITTER_CARD = {
  ...
  'site': '@flancian',        # twitter nick for the website
  'creator': '@flancian',     # Username for the content creator / author.
}
